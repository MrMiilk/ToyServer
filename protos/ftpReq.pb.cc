...
extern PROTOBUF_INTERNAL_EXPORT_ftpReq_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FtpFileInfo_ftpReq_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ftpReq_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FtpUserInfo_ftpReq_2eproto;
namespace protos {
...
static void InitDefaultsscc_info_FtpFileInfo_ftpReq_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FtpFileInfo_ftpReq_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_FtpFileInfo_ftpReq_2eproto}, {}};

static void InitDefaultsscc_info_FtpReq_ftpReq_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_FtpReq_ftpReq_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_FtpReq_ftpReq_2eproto}, {
      &scc_info_FtpUserInfo_ftpReq_2eproto.base,
      &scc_info_FtpFileInfo_ftpReq_2eproto.base,}};

static void InitDefaultsscc_info_FtpUserInfo_ftpReq_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FtpUserInfo_ftpReq_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_FtpUserInfo_ftpReq_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ftpReq_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_ftpReq_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ftpReq_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ftpReq_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::protos::FtpReq, userinfo_),
  PROTOBUF_FIELD_OFFSET(::protos::FtpReq, fileinfo_),
  PROTOBUF_FIELD_OFFSET(::protos::FtpReq, key_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::protos::FtpUserInfo)},
  { 6, -1, sizeof(::protos::FtpFileInfo)},
  { 15, -1, sizeof(::protos::FtpReq)},
};
...
const char descriptor_table_protodef_ftpReq_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014ftpReq.proto\022\006protos\"\033\n\013FtpUserInfo\022\014\n"
  "\004name\030\001 \001(\t\"D\n\013FtpFileInfo\022\014\n\004name\030\001 \001(\t"
  "\022\014\n\004path\030\002 \001(\t\022\013\n\003fid\030\003 \001(\r\022\014\n\004size\030\004 \001("
  "\r\"\205\001\n\006FtpReq\022%\n\010userInfo\030\001 \001(\0132\023.protos."
  "FtpUserInfo\022%\n\010fileInfo\030\002 \001(\0132\023.protos.F"
  "tpFileInfo\022\013\n\003key\030\003 \001(\t\" \n\004Type\022\014\n\010DOWNL"
  "OAD\020\000\022\n\n\006UPLOAD\020\001b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ftpReq_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ftpReq_2eproto_sccs[3] = {
  &scc_info_FtpFileInfo_ftpReq_2eproto.base,
  &scc_info_FtpReq_ftpReq_2eproto.base,
  &scc_info_FtpUserInfo_ftpReq_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_ftpReq_2eproto_once;
static bool descriptor_table_ftpReq_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ftpReq_2eproto = {
  &descriptor_table_ftpReq_2eproto_initialized, descriptor_table_protodef_ftpReq_2eproto, "ftpReq.proto", 265,
  &descriptor_table_ftpReq_2eproto_once, descriptor_table_ftpReq_2eproto_sccs, descriptor_table_ftpReq_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_ftpReq_2eproto::offsets,
  file_level_metadata_ftpReq_2eproto, 3, file_level_enum_descriptors_ftpReq_2eproto, file_level_service_descriptors_ftpReq_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ftpReq_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ftpReq_2eproto), true);
namespace protos {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* FtpReq_Type_descriptor() {
  ...
  return file_level_enum_descriptors_ftpReq_2eproto[0];
}
...
constexpr FtpReq_Type FtpReq::DOWNLOAD;
constexpr FtpReq_Type FtpReq::UPLOAD;
...
void FtpUserInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FtpUserInfo_ftpReq_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void FtpFileInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FtpFileInfo_ftpReq_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  path_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void FtpReq::InitAsDefaultInstance() {
  ::protos::_FtpReq_default_instance_._instance.get_mutable()->userinfo_ = const_cast< ::protos::FtpUserInfo*>(
      ::protos::FtpUserInfo::internal_default_instance());
  ::protos::_FtpReq_default_instance_._instance.get_mutable()->fileinfo_ = const_cast< ::protos::FtpFileInfo*>(
      ::protos::FtpFileInfo::internal_default_instance());
}
class FtpReq::_Internal {
 public:
  static const ::protos::FtpUserInfo& userinfo(const FtpReq* msg);
  static const ::protos::FtpFileInfo& fileinfo(const FtpReq* msg);
};

const ::protos::FtpUserInfo&
FtpReq::_Internal::userinfo(const FtpReq* msg) {
  return *msg->userinfo_;
}
const ::protos::FtpFileInfo&
FtpReq::_Internal::fileinfo(const FtpReq* msg) {
...
void FtpReq::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FtpReq_ftpReq_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "protos.FtpReq.key"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
